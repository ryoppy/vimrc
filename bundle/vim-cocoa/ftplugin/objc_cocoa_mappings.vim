...
" Cmdが効かないのでleaderで再定義 --------
nn <buffer> <silent> <leader>a :cal<SID>AlternateFile()<cr>
nn <buffer> <silent> <leader>b :w<bar>cal<SID>XcodeRun('build')<cr>
nn <buffer> <silent> <leader>r :w<bar>cal<SID>BuildAnd('launch')<cr>
nn <buffer> <silent> <leader>c :w<bar>cal<SID>BuildAnd('clean')<cr>
nn <buffer> <silent> <leader>m :<c-u>ListMethods<cr>
"-----------------------------------------
